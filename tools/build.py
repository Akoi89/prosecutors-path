...
# the output on purpose (v1.4.2: seven examine rows that had lost their message
# box - a hang - keep the fan's row instead).
REFERENCE_ROM_SHA256 = '3c91065cef5c75ae5890ce2931576faca080203ac250588828411d0918c2536c'
